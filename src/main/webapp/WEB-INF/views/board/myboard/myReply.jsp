...
<div id="container" class="article">
    ...
    <h3 class="small">${reply.board.user.username}</h3>
</c:when>
						<c:otherwise>
	...
	<c:set var = "sum" value = "0" />
					<c:set var= "sum" value="${sum + fn:length(reply.board.replys)}"/>
					<c:forEach var="reply" items="${reply.board.replys}">
